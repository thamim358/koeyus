      ...
      >
        <div className="">
          ...
          <div className="">
            ...
            <p className="mt-2 text-gray-500 text-base  wow fadeInUp">
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">1. Acceptance of Terms</h2>
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">2. Services</h2>
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">3. Client Responsibilities</h2>
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">4. Payment</h2>
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">5. Intellectual Property</h2>
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">6. Confidentiality</h2>
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">7. Changes to Services</h2>
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl">8. Dispute Resolution</h2>
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">9. Limitation of Liability</h2>
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
            ...
            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">10. Governing Law</h2>
            <p>
              These terms and conditions are governed by and construed in
              accordance with the laws of [Your Jurisdiction].
            </p>

            <h2 className="mt-2 text-[#ffd300] font-bold text-xl  wow fadeInUp">11. Contact Information</h2>
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
