        ...
        <div className="py-10 sm:px-2">
          <div className="p-10 flex flex-col lg:flex-row justify-between items-start lg:items-center">
            ...
            <div className="w-full lg:w-3/5 flex flex-col p-6 justify-start items-start lg:items-end  ">
              <div className="text-4xl text-[#FFBF00] font-bold mb-1 lg:mb-3 self-start font-Achi wow fadeInUp">
             About Us
              </div>
              ...
              <div className="  ">
              <div className="text-2xl text-[#FFBF00] font-bold font-Achi lg:mb-2 self-start  wow fadeInUp">
             Our Vision
              </div>
              <div className="text-medium text-[#7B7B7B] font-normal leading-relaxed  lg:mb-3 wow fadeInUp">
              ...
              <div className="text-2xl text-[#FFBF00] font-Achi font-bold mb-2 lg:mb-3 self-start  wow fadeInUp">
             Our Mission
              </div>
